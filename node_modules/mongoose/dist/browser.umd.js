 ...
 * @api private
 */
m.prototype._applySetters=function(t,e,r,n){var i=t,o=this.setters,s=this.caster,a=!0,u=!1,c=void 0;try{for(var l,f=d.clone(o).reverse()[Symbol.iterator]();!(a=(l=f.next()).done);a=!0){i=l.value.call(e,i,this)}}catch(t){u=!0,c=t}finally{try{!a&&f.return&&f.return()}finally{if(u)throw c}}if(Array.isArray(i)&&s&&s.setters){var h=[],p=!0,y=!1,v=void 0;try{for(var _,m=i[Symbol.iterator]();!(p=(_=m.next()).done);p=!0){var g=_.value;h.push(s.applySetters(g,e,r,n))}}catch(t){y=!0,v=t}finally{try{!p&&m.return&&m.return()}finally{if(y)throw v}}i=h}return i},m.prototype.applySetters=function(t,e,r,n,i){var o=this._applySetters(t,e,r,n,i);return null==o?o:o=this.cast(o,e,r,n,i)},m.prototype.applyGetters=function(t,e){var r=t,n=this.getters,i=n.length;if(0===i)return r;for(var o=0;o<i;++o)r=n[o].call(e,r,this);return r},m.prototype.select=function(t){return this.selected=!!t,this},m.prototype.doValidate=function(t,e,r,n){var o=!1,s=this.path,a=this.validators.filter(function(t){return null!=t&&"object"===(void 0===t?"undefined":i(t))}),u=a.length;if(!u)return e(null);var c=this;function l(t,r){if(!o)if(void 0===t||t)--u<=0&&f(function(){e(null)});else{var n=r.ErrorConstructor||_;(o=new n(r))[y]=!0,f(function(){e(o)})}}a.forEach(function(e){if(!o){var i=e.validator,a=void 0,u=d.clone(e);if(u.path=n&&n.path?n.path:s,u.value=t,i instanceof RegExp)l(i.test(t),u);else if("function"==typeof i)if(void 0!==t||i===c.requiredValidator)if(u.isAsync)!
/*!
 ...
 */
t.exports=function(t){var e=[],r=new WeakMap,o=t.constructor.indexTypes,s=new Map;return function t(a,u,c){if(!r.has(a)){r.set(a,!0),u=u||"";var l=Object.keys(a.paths),f=!0,h=!1,p=void 0;try{for(var d,y=l[Symbol.iterator]();!(f=(d=y.next()).done);f=!0){var v=d.value,_=a.paths[v];if(null==c||!c.paths[v]){if(_.$isMongooseDocumentArray||_.$isSingleNested){if(!0!==n(_,"options.excludeIndexes")&&!0!==n(_,"schemaOptions.excludeIndexes")&&!0!==n(_,"schema.options.excludeIndexes")&&t(_.schema,u+v+"."),null!=_.schema.discriminators){var m=_.schema.discriminators,g=Object.keys(m),b=!0,w=!1,O=void 0;try{for(var S,A=g[Symbol.iterator]();!(b=(S=A.next()).done);b=!0)t(m[S.value],u+v+".",_.schema)}catch(t){w=!0,O=t}finally{try{!b&&A.return&&A.return()}finally{if(w)throw O}}}if(_.$isMongooseDocumentArray)continue}var E=_._index||_.caster&&_.caster._index;if(!1!==E&&null!==E&&void 0!==E){var $={},j=i(E),x=j?E:{},N="string"==typeof E?E:!!j&&E.type;N&&-1!==o.indexOf(N)?$[u+v]=N:x.text?($[u+v]="text",delete x.text):$[u+v]=1,delete x.type,"background"in x||(x.background=!0);var P=x&&x.name;"string"==typeof P&&s.has(P)?Object.assign(s.get(P),$):(e.push([$,x]),s.set(P,$))}}}}catch(t){h=!0,p=t}finally{try{!f&&y.return&&y.return()}finally{if(h)throw p}}r.delete(a),u?
/*!
